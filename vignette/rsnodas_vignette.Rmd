...
download_prism(sp_res = "4km", data = c("ppt"), t_res = "monthly",
               start_date = as.Date("2021-03-01"), end_date = as.Date("2021-03-15"),  
...
The following code creates a GAM with the SNOTEL station information using March 2022 PRISM monthly precipitation.
